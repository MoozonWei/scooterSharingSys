...
public class ScooterUsage extends JFrame {
    ...
    public ScooterUsage() {
        ...
        no_of_empty_slots.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 12));
        ...
        jf.setVisible(true);
        b1.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 12));
